...
describe("listAllUsersInDb", () => {
  ...
  it("should return the list of all users in DB", async () => {
    await executeQuery("INSERT INTO users(id, name, creationDate) VALUES (?, ?, ?)", [
      "1",
      "Aetheldred",
    ...
    expect(users).toEqual([
      { id: "1", name: "Aetheldred", creationDate: new Date("1978-03-04T06:07:08Z") },
      { id: "2", name: "Jean-Georges", creationDate: new Date("2020-02-03T06:07:08Z") }
    ]);
  });
});
